                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: TextField(
                              decoration: InputDecoration(
                                labelText: "Helmet serial number",
                                prefixIcon: Icon(
                                  Icons.numbers,
                                  color: Color.fromARGB(255, 11, 85, 107),
                                ),
                                filled:
                                    true, // Ensures that the background color is applied
                                // fillColor: Color.fromARGB(255, 196, 210, 240),
                                fillColor: Color.fromARGB(255, 234, 241, 255),
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: Color.fromARGB(239, 196, 5, 5)),
                                child: Center(
                                  child: Text(
                                    "Save",
                                    style: TextStyle(
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(10),
                                      color: Color.fromARGB(235, 51, 119, 165)),
                                  child: Center(
                                    child: Text(
                                      "User List",
                                      style: TextStyle(
