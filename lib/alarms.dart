  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        Center(
          child: Padding(
            // padding: const EdgeInsets.only(left: 450, right: 300, top: 220),
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              title: Text('Alert'),
                              content: Text(
                                'Alert sent to user xyz with Helmet ID 01.',
                              ),
                              actions: [
                                TextButton(
                                  onPressed: () {
                    ...
                    ElevatedButton(
                      onPressed: () {
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              title: Text('Evacuation Alert'),
                              content: Text(
                                'Emergency Alert send to all the users',
                              ),
                              actions: [
                                TextButton(
                                  onPressed: () {
